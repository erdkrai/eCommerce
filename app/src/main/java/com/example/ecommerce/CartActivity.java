    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nextProcessBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                txtTotalAmount.setText("Total Price = INR" + String.valueOf(overTotalPrice));
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()){
                    ...
                    if (shippingState.equals("Shipped")){
                        ...
                        txtMsg1.setText("Congratulations Your Final Order has Been Shipped Sucessfully, Soon you will recieve your order at your doorstep");
                        nextProcessBtn.setVisibility(View.GONE);
                        Toast.makeText(CartActivity.this, "You Can Purchase More Products once you Recieved your first final Order", Toast.LENGTH_LONG).show();
                    }
